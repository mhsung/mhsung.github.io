...
\item \label{cvpr22_2}
\textbf{Pop-Out Motion: 3D-Aware Image Deformation via Learning Shape Laplacian}\\
Jihyun Lee*, \textbf{Minhyuk Sung}*, Hyunjin Kim, Tae-Kyun Kim (* equal contribution)\\
(* Equal contribution)\\
CVPR 2022\\
\blankline
...
Reviewer & SIGGRAPH, SIGGRAPH Asia, Eurographics, \\
  & CVPR, ICCV, 3DV, WACV, NeurIPS, ICML, ICLR, \\
